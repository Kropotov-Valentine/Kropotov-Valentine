...
Подготовить датасет к работе, исследовать динамику и структуру финансирования стартапов и получить ниформацию, которая важна для оценки инвестиционных стратегий.
